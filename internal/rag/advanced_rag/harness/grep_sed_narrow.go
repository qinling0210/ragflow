...
//
// It mirrors the Claude Code / Codex ``grep`` + ``sed`` workflow, but operates on
...
//	     safety valve)
//
// Safety: only regexp + pure string ops, no eval, no arbitrary code; grep-term
// count cap + context clamp.
