...
func TestIsFactDenseSentence(t *testing.T) {
	cases := []struct {
		...
		{"Culdcept was released in 1999 by OmiyaSoft with 50 cards.", true}, // digit
		{"He said \"hello\" to the group about the meeting.", true},         // quoted
		{"the cat sat on the mat and looked at the bird outside.", true},    // >=6 tokens
