...
// userDefined it returns the embedded citation_prompt.md; a non-empty
// userDefined (the rendered user_defined_prompts) replaces it verbatim, exactly
// as Python returns citation_prompt(self.user_defined_prompts).
